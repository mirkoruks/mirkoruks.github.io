...
Here, ![f2] (sigma) is the population covariance matrix, while ![f3] is a vector containing the model parameters and ![f4] is the covariance matrix as a function of the model parameters. 
...
Here, the idea behing the formula is the same as with the covariance matrix, only that ![f6] refers to the means vector.
