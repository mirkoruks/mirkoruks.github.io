...
**F** is a ![f9]-matrix that makes the computer know which of the matrices are manifest and which of them are latent. The dimensions of the matrix are: ![f10]  blabla
...
[f10]: <img src="https://render.githubusercontent.com/render/math?math=e^{i \pi} = -1">
